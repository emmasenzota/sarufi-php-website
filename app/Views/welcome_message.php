...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to Sarufi enabled by CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

        <h2>The small framework with powerful features that helps quick deployment of solutions</h2>
...
<footer>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> Neurotech's Sarufi AI.</p>
